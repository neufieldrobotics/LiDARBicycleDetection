function distMat = euclidDist2PointClouds(ptCloudA,ptCloudB)
...
reference = ptCloudA.Location; % reference = M x N matrix
sample = ptCloudB.Location; % sample    = P x N matrix
